...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  size="lg" 
                  className="text-base px-8 shadow-lg w-full sm:w-auto"
      ...
      {/* Book Appointment Section - Hero */}
      <section id="book-appointment-section" className="py-20 md:py-24 bg-gradient-to-br from-accent/30 to-background">
      ...
      {/* Book Appointment Section - Information */}
      {!isSubmitted && (
